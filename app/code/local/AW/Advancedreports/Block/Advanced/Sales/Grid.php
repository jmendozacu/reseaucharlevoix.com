...
class AW_Advancedreports_Block_Advanced_Sales_Grid extends AW_Advancedreports_Block_Advanced_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('order_country', array(
        ...
        $this->addColumn('order_region', array(
        ...
        $this->addColumn('order_city', array(
        ...
        $this->addColumn('order_postcode', array(
        ...
        $this->addColumn('order_created_at', array(
        		'header' => $this->_helper()->__('Heure Debut'),
        ...
        $this->addColumn('base_original_xprice', array(
