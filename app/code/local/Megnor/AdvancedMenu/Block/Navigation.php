...
class Megnor_AdvancedMenu_Block_Navigation extends Mage_Catalog_Block_Navigation
{
    ...
    public function drawAdvancedMenuItem($category, $level = 0, $last = false)
    {
        ...
        if ($drawPopup)
        {
            $html[] = '<div id="menu' . $id . '" class="menu menu-arrow' . $active . '" onmouseover="megnorShowMenuPopup(this, \'popup' . $id . '\');" onmouseout="megnorHideMenuPopup(this, event, \'popup' . $id . '\', \'menu' . $id . '\')">';
        }
        else
        {
