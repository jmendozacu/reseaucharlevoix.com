    ...
    public function getPaymentPaidInfo(){
        ...
        $collection = Mage::getModel('sales/order')->getCollection()
            ...
            $collection = Mage::getModel('sales/order')->getCollection()
                ->addAttributeToSelect('*')
                ->addAttributeToFilter('created_at', array('from'=>$previous_time))
                ->addAttributeToFilter('till_id',array('null'=>true))
                ->load();
        ...
        foreach($collection as $order){
            ...
            if(in_array($payment,$payment_arr)){
                ...
                if($payment == 'checkmo' || $payment == 'xpayment_cashpayment' || $payment == 'ccsave' || $payment == 'xpaymentMultiple' ){
                    switch($payment){
                        case 'checkmo' :
                        ...
                        case 'xpaymentMultiple':
                            $data[$payment]['payment_name'] = 'Split Payment' ;
