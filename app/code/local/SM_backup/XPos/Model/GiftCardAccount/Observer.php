    ...
    public function processOrderCreationData(Varien_Event_Observer $observer){
        ...
        if (isset($request['giftcard_add'])) {
            ...
            try {
                ...
                Mage::throwException(
                    //Mage::getSingleton('adminhtml/session')->addSuccess('Apply Gift Card Successfully')
                    Mage::helper('enterprise_giftcardaccount')->__('Apply Gift Card Successfully')
                );
            } catch (Mage_Core_Exception $e) {
        ...
        if (isset($request['giftcard_remove'])) {
            ...
            try {
                ...
                Mage::throwException(
                    Mage::helper('enterprise_giftcardaccount')->__('Remove Gift Card Successfully')
                );
            } catch (Mage_Core_Exception $e) {
                Mage::getSingleton('adminhtml/session_quote')->addError(
                    $e->getMessage()
