...
class Drieworks_EmailAttachments_Model_Core_Email_Template_Mailer extends Mage_Core_Model_Email_Template_Mailer
{
    ...
    public function dispatchAttachEvent($emailTemplate)
    {
		...
		Mage::Log("Mailer TEMPLATE id: " . $this->getTemplateId());
        ...
        switch ( $this->getTemplateId()) {
            ...
            case Mage::getStoreConfig(Mage_Sales_Model_Order::XML_PATH_EMAIL_GUEST_TEMPLATE, $storeId):
                Mage::dispatchEvent('drieworks_emailattachments_before_send_order',
                                array(
                                    'update'=> false,
            ...
            case Mage::getStoreConfig(Mage_Sales_Model_Order_Invoice::XML_PATH_EMAIL_GUEST_TEMPLATE, $storeId):
                Mage::dispatchEvent('drieworks_emailattachments_before_send_invoice',
                                array(
                                    'update'=> false,
                                    'template' => $emailTemplate,
            ...
            case Mage::getStoreConfig(Mage_Sales_Model_Order_Shipment::XML_PATH_EMAIL_GUEST_TEMPLATE, $storeId):
                Mage::dispatchEvent('drieworks_emailattachments_before_send_shipment',
                                array(
                                    'update'=> false,
                                    'template' => $emailTemplate,
            ...
            case Mage::getStoreConfig(Mage_Sales_Model_Order_Creditmemo::XML_PATH_EMAIL_GUEST_TEMPLATE, $storeId):
                Mage::dispatchEvent('drieworks_emailattachments_before_send_creditmemo',
                                array(
                                    'update'=> false,
                                    'template' => $emailTemplate,
