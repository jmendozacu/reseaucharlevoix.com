...
class Itoris_GroupedProductConfiguration_Admin_ConfigurationController extends Itoris_GroupedProductConfiguration_Controller_Admin_Controller {
	...
	public function saveAction() {
        ...
        try{
            Mage::getModel('itoris_groupedproductconfiguration/settings')->save($settings, $scopeData['scope'], $scopeData['scope_id']);
