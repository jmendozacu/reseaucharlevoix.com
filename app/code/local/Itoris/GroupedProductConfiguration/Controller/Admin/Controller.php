...
class Itoris_GroupedProductConfiguration_Controller_Admin_Controller extends Mage_Adminhtml_Controller_Action {
	...
	public function preDispatch() {
		...
		if (!Itoris_Installer_Client::isAdminRegistered($helper->getAlias())) {
			...
			$register = $this->getLayout()->createBlock('itoris_groupedproductconfiguration/admin_register');
