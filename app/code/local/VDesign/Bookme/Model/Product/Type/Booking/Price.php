		...
		if ($optionIds = $product->getCustomOption('option_ids')) {
			...
			foreach (explode(',', $optionIds->getValue()) as $optionId) {
				if ($option = $product->getOptionById($optionId)) {
					...
					Mage::log("VDesign _applyOptionsPrice");
					if($group instanceof VDesign_Bookme_Model_Catalog_Product_Option_Type_Multidate)
					{
						...
						//Eric: Price per option, dont add product price pour selection_siege
						if($group instanceof VDesign_Bookme_Model_Catalog_Product_Option_Type_Selectionsiege)
						{
			...
			Mage::log($finalPrice);
			Mage::log($product->getFinalPrice());
