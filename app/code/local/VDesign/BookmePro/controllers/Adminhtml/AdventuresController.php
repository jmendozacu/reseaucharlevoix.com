...
class VDesign_BookmePro_Adminhtml_AdventuresController extends Mage_Adminhtml_Controller_Action{
	
	public function indexAction()
	{
		$this->loadLayout()->_setActiveMenu('bookmepro/adventure');
		$this->_addContent($this->getLayout()->createBlock('bookmepro/adminhtml_adventures'));
		$this->renderLayout();
	}
	public function gridAction()
	{
		...
		$this->getResponse()->setBody(
				$this->getLayout()->createBlock('bookmepro/adminhtml_adventures_grid')->toHtml()
		);
	}
	...
	{
		$fileName = 'adventures.csv';
		$grid = $this->getLayout()->createBlock('bookmepro/adminhtml_adventures_grid');
		$this->_prepareDownloadResponse($fileName, $grid->getCsvFile());
	}
	public function exportExcelAction()
	{
		$fileName = 'adventures.xml';
		$grid = $this->getLayout()->createBlock('bookmepro/adminhtml_adventures_grid');
