 ...
 */
class VDesign_BookmePro_Block_Order_Email_Items_Order_Booking extends Mage_Sales_Block_Order_Email_Items_Order_Default
{
	...
	public function getBookValue($data){
    	...
    	$config = Mage::getStoreConfig('bookmepro_sales/sales/order_email', Mage::app()->getStore()->getId());
