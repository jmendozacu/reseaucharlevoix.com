 ...
 */
class VDesign_BookmePro_Block_Adminhtml_Adventure_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
    ...
    public function __construct()
    {
        ...
        //$this->_updateButton('save', 'label', Mage::helper('bookmepro')->__('Save Survey'));
        ...
        $this->_addButton('save', array(
        		...
        		'onclick'   => "adventure_editForm.submit()",//'setLocation(\'' . $this->getUrl('*/adminhtml_session/save' , array('item_id' => $this->getRequest()->getParam('item_id'))) .'\')',
        		'class'     => 'save',
        ), -100);
        
        $this->_addButton('delete', array(
        		'label'     => Mage::helper('bookmepro')->__('Delete Reservation'),
        		'onclick'   => "if(confirm('Do you really want to delete this reservation?')) setLocation('" . $this->getUrl('*/adminhtml_adventure/delete' , array('item_id' => $this->getRequest()->getParam('item_id'))) ."');",
        		'class'     => 'delete',
        ), -100);
    }
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('bookmepro/survey_index/' . $action);
    }
