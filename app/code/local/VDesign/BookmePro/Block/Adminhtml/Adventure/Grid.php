 ...
 */
class VDesign_BookmePro_Block_Adminhtml_Adventure_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	public function __construct()
	{
		date_default_timezone_set(Mage::app()->getStore()->getConfig('general/locale/timezone'));
		parent::__construct();
		$this->setId('adminhtml_adventure_grid');
	...
	protected function _prepareColumns()
	{
		...
		if (Mage::getSingleton('admin/session')->isAllowed('sales/order/actions/view')) {
			$this->addColumn('action',
					array(
							...
							'actions'   => array(
									array(
											'caption' => Mage::helper('sales')->__('Edit Adventure Time'),
											'url'     => array('base' => '*/adminhtml_adventure/edit'),
											'field'   => 'item_id'
									)
							),
							'filter'    => false,
		...
		$this->addExportType('*/adminhtml_adventure/exportCsv', $helper->__('CSV'));
		$this->addExportType('*/adminhtml_adventure/exportExcel', $helper->__('Excel XML'));
