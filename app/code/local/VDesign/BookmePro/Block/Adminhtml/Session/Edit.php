 ...
 */
class VDesign_BookmePro_Block_Adminhtml_Session_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->_addButton('myback', array(
        		...
        		'onclick'   => 'setLocation(\'' . $this->getUrl('*/adminhtml_session/delete' , array('item_id' => $this->getRequest()->getParam('item_id'))) .'\')',
        		'class'     => 'back',
        ), -100);
        ...
        $this->_addButton('save', array(
        		...
        		'onclick'   => "sessions_editForm.submit()",//'setLocation(\'' . $this->getUrl('*/adminhtml_session/save' , array('item_id' => $this->getRequest()->getParam('item_id'))) .'\')',
        		'class'     => 'save',
        ), -100);
        
        $this->_addButton('delete', array(
        		'label'     => Mage::helper('bookmepro')->__('Delete Reservation'),
        		'onclick'   => "if(confirm('Do you really want to delete this reservation?')) setLocation('" . $this->getUrl('*/adminhtml_session/delete' , array('item_id' => $this->getRequest()->getParam('item_id'))) ."');",
        		'class'     => 'delete',
        ), -100);
    }
