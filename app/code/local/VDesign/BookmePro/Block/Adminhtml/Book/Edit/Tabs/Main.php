...
class VDesign_BookmePro_Block_Adminhtml_Book_Edit_Tabs_Main
...
//         }
        ...
        $fieldset->addField('from_to', 'select', array(
        		'label'     => Mage::helper('bookmepro')->__('Session Time'),
        		'title'     => Mage::helper('bookmepro')->__('Session Time'),
        		'name'      => 'from_to',
        		'required'  => true,
        		'options'   => Mage::helper('bookmepro')->getAvailableDateList($model),
