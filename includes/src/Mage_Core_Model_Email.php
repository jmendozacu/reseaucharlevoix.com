...
class Mage_Core_Model_Email extends Varien_Object
{
    ...
    {
	/** $config = array('ssl' => 'tls', 'port' => 587, 'auth' => 'login', 'username' => 'info_reseaucharlevoi', 'password' => 'Patate2000');
    $transport = new Zend_Mail_Transport_Smtp('smtp04.sherweb2010.com', $config);
			*/
