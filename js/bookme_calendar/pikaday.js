...
}(this, function (moment)
{
    ...
    renderTable = function(opts, data)
    {
        ...
        return '<div style="float:left"><table cellpadding="0" cellspacing="0" class="pika-table">' + renderHead(opts) + renderBody(data) + '</table>' +
    ...
    Pikaday.prototype = {
        ...
        refreshExcludeDays: function(){
        	...
        	new Ajax.Request(this.baseUrl + 'index/day?isAjax=true&id='+this._id+'&month='+month+'&year='+year, {
        		method: 'get',
        	    asynchronous: true,
        ...
        refreshSessions: function(){
        	...
        	new Ajax.Request(this.baseUrl + 'index/session?isAjax=true&id='+this._id+'&date='+this._sessionDate.getFullYear()+'/'+this._sessionDate.getMonth()+'/'+this._sessionDate.getDate(), {
        		method: 'get',
        	    asynchronous: true,
                onSuccess: function(transport) {
        ...
        refreshMaxQty: function(){
        	if(this._o.field.value != ''){
	        	new Ajax.Request(this.baseUrl + 'index/maxqty?isAjax=true&id='+this._id+'&dates='+this._o.field.value+'&offset='+$('options_multidate_offset').value, {
	        		method: 'get',
	        	    asynchronous: true,
	                onSuccess: function(transport) {
	                	var response = transport.responseText.evalJSON();
