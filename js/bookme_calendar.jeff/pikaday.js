...
}(this, function (moment)
{
    ...
    renderSessions = function(opts){
    	if(opts.type != 'Session')
    		return '';
    	var html = '<div style="float:left; height:200px; width: 100px; margin-left:15px">';
    	html += '<p style="color: rgb(153, 153, 153);font-size: 12px;line-height: 25px;font-weight: bold;text-align: center; margin: 0px">D&eacute;part</p>';
    ...
    secondsToHms= function(d) {
    	...
    	return ((h > 0 ? (h < 10 ? "0"+h+":" : h + ":") : "00:") + (m > 0 ? (h > 0 && m < 10 ? "00" : "") + m + "" : "00")); 
    },
    ...
    Pikaday.prototype = {
        ...
        refreshExcludeDays: function(){
        	...
        	new Ajax.Request(this.baseUrl + 'index.php/bookme_calendar/index/day?isAjax=true&id='+this._id+'&month='+month+'&year='+year, {
        		method: 'get',
        	    asynchronous: true,
        ...
        refreshSessions: function(){
        	...
        	new Ajax.Request(this.baseUrl + 'index.php/bookme_calendar/index/session?isAjax=true&id='+this._id+'&date='+this._sessionDate.getFullYear()+'/'+this._sessionDate.getMonth()+'/'+this._sessionDate.getDate(), {
        		method: 'get',
        	    asynchronous: true,
                onSuccess: function(transport) {
        ...
        refreshMaxQty: function(){
        	if(this._o.field.value != ''){
	        	new Ajax.Request(this.baseUrl + 'index.php/bookme_calendar/index/maxqty?isAjax=true&id='+this._id+'&dates='+this._o.field.value+'&offset='+$('options_multidate_offset').value, {
	        		method: 'get',
	        	    asynchronous: true,
	                onSuccess: function(transport) {
	                	var response = transport.responseText.evalJSON();
