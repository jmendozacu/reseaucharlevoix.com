        ...
        <div class="paper" style="max-width:">\
            ...
            <div class="items-view" style="{htmlSeparatorStyle}">\
                <table>\
                    <thead>\
                        <tr>\
                            <th class="item-name" data-metadata="item-name" align="left">ITEM</th>\
                            <th data-metadata="qty">Qty</th>\
                            <th class="price-container" data-metadata="price">PRICE</th>\
                            <th class="tax" data-metadata="tax-amount">TAX</th>\
                            <th class="row-total" data-metadata="row-total" align="right">SUBTOTAL</th>\
                        </tr>\
                    </thead>\
                    <tbody>\
                        {order_items}\
...
//                var optionName = option.name.replace('[', '][');
    ...
    additionalFields.forEach(function(value, index) {
        switch (value) {
            case 'tax':
                orderReceipt.taxContainer = nano(sumUpTemplate, {'title':'TAXES', 'value':orderReceipt.tax});
                break;
            case 'discount':
                orderReceipt.discountContainer = nano(sumUpTemplate, {'title':'DISCOUNT', 'value':orderReceipt.discount});
                break;
            case 'subtotal':
                orderReceipt.subtotalContainer = nano(sumUpTemplate, {'title':'SUBTOTAL', 'value':orderReceipt.subtotal});
                break;
        }
    });
